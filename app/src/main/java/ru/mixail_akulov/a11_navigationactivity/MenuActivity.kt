...
import ru.mixail_akulov.a11_navigationactivity.model.Options
import ru.mixail_akulov.a11_navigationactivity.databinding.ActivityMenuBinding
...
class MenuActivity : BaseActivity() {
    ...
    // сюдаприходит результат работы из других активити по коду requestCode. Код resultCode показывает было ли
